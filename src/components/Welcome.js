      ...
      <div className="box">
        ...
        <article className={styles.description}>
          ...
          <p>
            ...
            Explore several art forms as your child builds creativity and confidence in our new
            visual arts classes for ages 2-5.
          </p>
          <p>
          ...
          <p>
            ...
            music studios and rehearsal spaces. Access to advanced degree programs in future. You
            can improve your musical skills like our students below by enrolling in our specialized
            classes.
          </p>
        </article>
      </div>
      <div className="box">
        <h1 className="heading">Partnered with</h1>
        <p>
          It is affiliated to{' '}
          <strong>
            <a href="https://www.rslawards.com/rockschool/" target="_blank">
              RSL
            </a>
          </strong>{' '}
          music academy. You would get a certification of the school.
        </p>
        <div className={styles.affiliate}>
          <a href="https://www.rslawards.com/rockschool/" target="_blank">
            <Image src="/rsl.svg" width="100" height="100" alt="RSL school" />
          </a>
        </div>
      </div>
    </>
